          ...
          return (
            ...
            >
              ...
              <div className="absolute top-3 left-3 bg-black/50 backdrop-blur px-3 py-1 rounded-full text-white opacity-0 group-hover:opacity-100 duration-200 text-sm flex items-center gap-4">
                ...
                <span className="flex items-center gap-1">
                  <img src={DownvoteIcon} alt="Downvotes" className="h-6 w-6 invert translate-y-[3px]" />
                  {it.downvoteCount}
                </span>
              </div>
              ...
              >
                <img src={UpvoteIcon} alt="Upvote" className="h-6 w-6 invert" />
              ...
              >
                <img src={DownvoteIcon} alt="Downvote"   className="h-6 w-6 invert translate-y-[3px]" />
                <span className="whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  Downvote
                </span>
              </button>
          ...
          >
            ...
            <div className="p-4 flex justify-between items-center">
              ...
              <div className="font-medium text-gray-700 flex items-center gap-4">
                ...
                <span className="flex items-center gap-1">
                  <img src={DownvoteIcon} alt="Downvotes" className="h-6 w-6 invert" />
