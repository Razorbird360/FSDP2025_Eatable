import sunlightImage from "../assets/Onboarding3.png";
        ...
        <div className="flex flex-col items-center">
          <div className="mb-8 w-[min(520px,100%)]">
            ...
            <div className="overflow-hidden rounded-2xl bg-white shadow-[0_12px_40px_rgba(0,0,0,0.12)]">
              <img
                src={sunlightImage}
                alt="Make sure the dish fills 70% of the frame"
          ...
          <h1 className="mb-3 text-center text-xl font-semibold text-[#111827] md:text-2xl">
            Make sure the dish fills 70% of the frame
          </h1>

          <p className="max-w-xl text-center text-sm text-gray-600 md:text-base">
            Let your food take up most of the photo so it stands out clearly
            <br />
            Avoid leaving too much empty space around the dish
          </p>
