...
import { getNearbyHawkerCentres, getRandomStalls } from '../../hawkerCentres/api/hawkerCentres.api';
import type { HawkerCentreWithStalls } from '../../hawkerCentres/types/hawker.types';
 ...
 */
export const useHawkerCentres = (limit = 100): UseHawkerCentresResult => {
