...
const BASE_INSTRUCTIONS = [
  ...
  'Only provide tags that are important in highlighting the pro and cons of the food. Ignore any action phrases such as "licked plate clean".',
  'Keep the tags general and concise and related to the food.',
...
const HISTORY_INSTRUCTIONS = [
  ...
  'Try to merge tags that are baseline similar into one general',
  ...
  'If a new tag conflicts with another current tag (e.g., "fresh vegetables" + "stale vegetables"), reduce confidence of the current tag. Do not add the new tag. If the reduction of the confidence of current tag results in it going below 30%, add the new tag',
  'For new tags added, confidence starts at 0.5',
